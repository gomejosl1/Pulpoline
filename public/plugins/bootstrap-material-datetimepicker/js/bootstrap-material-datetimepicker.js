   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-cancel btn btn-outline-secondary m-r-10">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn btn-outline-info">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
