...
<!-- ESTA ES LA VENTANA DEL LOGIN -->
                ...
                <div id="alerta_mensaje" class="txtg" align="center" style="top: 20%;width:81.2%;">
                <div class="alerta_comentario">
                    ...
                    <form accept-charset="ISO-8859-1" action="http://autoliquidacionv2.ivss.gob.ve:28082/TiunaWeb/certificadoSolvenciaElectronico.htm" method="post" id="form_solvencia" name="form_solvencia" target="_blank">
                        ...
                        <section class="floating-labels mb-5">
                            <div class="row mt-4">
                                 <div class="col-4">
                                    <div class="form-group row">
                                        <label for="email" class="col-md-3 col-form-label text-md-left">Nombres</label>
                                        <div class="col-md-7">
                            ...
                            <div class="col-4">
                                    <div class="form-group row">
                                        <label for="email" class="col-md-3 col-form-label text-md-left">Apellidos</label>
                                        <div class="col-md-7">
                                            <input id="usuario" type="email" class="form-control " name="usuario" value="gomejosl1"  autofocus>
                                        </div>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                       <label for="exampleFormControlSelect1" class="col-md-4 col-form-label text-md-left">Lugar de Nacimiento</label>
                                       <div class="col-md-7">
                              ...
                              <div class="col-4">
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-left">Fecha de Nacimiento</label>
                                    <div class="col-md-6">
                                        <input id="usuario" type="email" class="form-control " name="usuario" value="24-07-2019"  autofocus>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="col-4">
                                <div class="form-group row">
                                    <label for="email" class="col-md-3 col-form-label text-md-left">Edad</label>
                                    <div class="col-md-7">
                                        <input id="usuario" type="email" class="form-control " name="usuario" value="24"  autofocus>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-left">Cedula</label>
                                    <div class="col-md-6">
                                        <input id="usuario" type="email" class="form-control " name="usuario" value="23990987"  autofocus>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                       <label for="exampleFormControlSelect1" class="col-md-4 col-form-label text-md-left">Género</label>
                                       <div class="col-md-6">
                                           <select class="form-control" id="exampleFormControlSelect1">
                            ...
                            <div class="col-4">
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-left">Número Telefónico</label>
                                    <div class="col-md-6">
                                        <input id="usuario" type="email" class="form-control " name="usuario" value="23990987"  autofocus>
                                    </div>
                                </div>
                        ...
                        <div>
                            <input type="button" class="btn btn-primary" onclick="mensaje_cerrar();" name="boton" value="Registrar"></div>
                        </form>
                    </div>
                </div>
<!-- ESTA ES LA VENTANA DEL LOGIN -->
