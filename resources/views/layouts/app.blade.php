...
<head>
    ...
    <style type="text/css">
        ...
        /*.navbar-brand{ background:#000; position:absolute; opacity:2; background:url(http://www.ivss.gob.ve/sites/aplicativo/imagen/ivss_logo.png) no-repeat center/contain;}*/
