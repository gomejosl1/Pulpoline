...
// Verificar si  tiene datos de Dialisis y farmacia
if ($(checkDialisis).is(':checked'))
        {
...
//Fin Verificar si  tiene datos de Dialisis
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Editar Beneficiario') }}</div>
                <div class="card-body">
                                {{ Form::open(['route' => ['beneficiarios.update', encrypt($beneficiarios->id)], 'method' => 'PUT']) }}
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="nombre" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                             ...
                             <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ old('nombre',$beneficiarios->nombre) }}" required autocomplete="nombre" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('cedula',$beneficiarios->cedula) }}" required autocomplete="cedula" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono',$beneficiarios->telefono) }}" required autocomplete="telefono" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="correo" type="email" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ old('correo',$beneficiarios->correo) }}" required autocomplete="email" autofocus>
                    ...
                    <div class="form-group row">
                         ...
                         <div class="col-md-6 row">  
                            <div class="custom-control custom-checkbox">
                                @if ($beneficiarios->id_centro_medico)
                              <input type="checkbox" class="custom-control-input" id="checkDialisis" name="check" checked>
                                @else
                              <input type="checkbox" class="custom-control-input" id="checkDialisis" name="check" >
                                @endif
                              <label class="custom-control-label" for="checkDialisis">Dialisis </label>
                          </div>

                            <div class="custom-control custom-checkbox">
                            @if ($beneficiarios->id_centro_medico)
                              <input type="checkbox" class="custom-control-input" id="checkFarmacia" name="check" checked>
                              @else
                            ...
                            <div class="form-row" >                        
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="fecha_dialisis" class="form-control floating-label fecha" placeholder="Fecha de dialisis" value="{{ old('fecha_dialisis',$beneficiarios->fecha_dialisis) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="hora_dialisis" class="form-control floating-label hora" placeholder="Fecha de dialisis" value="{{ old('hora_dialisis',$beneficiarios->hora_dialisis) }}" required>
                                        @error('hora_dialisis')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-4">
                                        <label for="id_centro_medico" class="col-md-12 col-form-label text-md-left">{{ __('Centro Médico') }}</label>
                                           <select name="id_centro_medico" id="centro_medico" class="form-control text-uppercase" required>
                                            ...
                                            @if($centro_medico->id == $beneficiarios->id_centro_medico)
                                            <option value="{{$centro_medico->id}}" selected>{{$centro_medico->nombre}}</option>
                                            @else
                        ...
                        <div class="form-row" >                        
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="fecha_retiro" name="fecha_retiro"class="form-control floating-label fecha" placeholder="Fecha de Retiro" value="{{ old('fecha_retiro',$beneficiarios->fecha_retiro) }}" required>
                                    @error('fecha_retiro')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="id_farmacia" id="id_farmacia" name="id_farmacia" class="form-control text-uppercase" required="required">
                                        ...
                                        @foreach ($farmacias as $key => $farmacia)
                                            @if($farmacia->id == $beneficiarios->id_farmacia)
                                            <option value="{{$farmacia->id}}" selected>{{$farmacia->nombre}}</option>
                                            @else
